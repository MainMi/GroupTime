                    ...
                    return (
                        <div className={classes.eventInfo} key={eventInfo.name + idx}>
                            ...
                            <div className={classes.sectionBox}>
                                ...
                                <span>{eventInfo.teacherName || '—'}</span>
                                ...
                                <span className={classes.tag}>
                                    {Array.isArray(eventInfo.tag)
                                        ? (eventInfo.tag.length ? eventInfo.tag.join(', ') : '—')
                                        : (eventInfo.tag || '—')}
                                </span>
                                ...
                                <span>{eventDate?.duration ? `${eventDate.duration} ${t('event.minutesShort')}` : '—'}</span>
                            </div>
